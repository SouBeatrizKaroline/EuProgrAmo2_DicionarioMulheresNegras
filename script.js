...
/* document.getElementById("id") - acessar de uma id no documento html*/

/* == - igual
!= - diferente */

/* "string" - declarar informação do tipo texto
alert() - criar um alerta em formato pop-up 

listener - fazer um evento
Ex: clicar
addEventListerner("click",nomeDaFuncao)

function - conglomerado de regras e comandos que será determinado para a aplicação
Ex: O que fazer após um evento, o back-end dele, enviar formulario, ou algo assim
function nomeDaFuncao(){...}
*/

/* var guardaRoupa = "roupas";
Armazenar uma informação X - Usar uma variavel
Variavel - Declara alguma coisa
var nomeDaVariavel = valor
var:variavel
guardaRoupa:  local onde armazenamos as informações
"roupas": Informação declarada que será armazenada
*/

/* Array - Permite que agregue varios valores dentro de uma unica variavel
var guardaRoupa = ["camisa","camiseta","roupa de cama","calça","peça íntima","toalha" 
var guardaRoupa: local onde armazenamos informações
["X","Y","Z"]: agrupamento de valores a serem armazenados
*/ 
...
/* Diferente da Array, o objeto consegue categorizar informação, ou seja utilizar informações mais detalhadas. */

    /* var nomeDaVariavel = {chave:valor} 
    var camisetas = {"camisa01":{manga:"curta, estampa:"lisa", tamanho:"grande"}, "camiseta02":{manga"longa", estampa:"listrada", tamanho:"pequeno"}};
    agrupamento de valores a serem armazenados por categorias*/

/* Laços de Repetição - for(){...} - Condensa informações em uma unica regra, instrução do que quer repetir
for (var item in obj){...} - o laço de repetição com "in" é usado para objeto
*/
...
/* for(item in camiseta){
  ...
  item in camiseta: cria a regra que determina a iteração do objeto
  + =: Operador de atribuição - armazenando, adicionando informações dentro da variavel item, alimentando a variavel
  */

function carregaDicionario() {
/* A função é onde armazena toda instrução do codigo */
    var biografias = {
      /* Array armazena varios valores*/
      bio01: {
